...
а не счёт с деньгами. Платёж по кредиту позже будет связываться
с Transaction, чтобы списывать деньги со счёта оплаты, но тело
кредита не должно становиться расходом.
"""
