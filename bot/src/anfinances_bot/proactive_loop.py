...
MEETING_PROMPT = (
    "Проведи бюджетное совещание: итоги прошлого месяца, что выбилось "
    "из плана, покрыты ли траты доходом прошлого месяца, и предложи, "
    "как разложить деньги на этот месяц. Коротко, числами из данных."
)
