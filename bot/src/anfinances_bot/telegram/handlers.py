...
async def handle_user_attachments(
    ...
    await _run(
        ...
        (
            ...
            "существующего дерева и разбери через preview_statement, "
            "по одному вызову на счёт. Он сверит строки с уже "
            "записанным и вернёт только новые. Покажи этот список "
            "целиком и спроси, заносить ли; сам ничего не заноси. "
            "Чего в документах не видно — не выдумывай, лучше "
            "переспроси.\n\n"
